...
Signup.create(user_id: harum.id, restaurant_id: 1)
Signup.create(user_id: leslie.id, restaurant_id: 1)
Signup.create(user_id: leslie.id, restaurant_id: 2)
Signup.create(user_id: harum.id, restaurant_id: 3)
Signup.create(user_id: leslie.id, restaurant_id: 4)
Signup.create(user_id: harum.id, restaurant_id: 5) 